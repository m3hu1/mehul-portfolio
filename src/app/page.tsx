  ...
  return (
    <>
      ...
      <main className="flex flex-col min-h-[100dvh] space-y-10">
              ...
              <div className="flex-col flex flex-1 space-y-1.5">
                <div className="flex items-center gap-3">
                  ...
                  <BlurFade delay={BLUR_FADE_DELAY}>
                    <motion.span
                      className="text-3xl sm:text-5xl xl:text-6xl inline-block origin-[70%_80%]"
                      animate={{
        ...
        {/* === OLD ABOUT (left-aligned + pink underline animation) ===
        <section id="about">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 3}>
            <div className="flex items-center w-full gap-0 mb-4">
              ...
              <div className="border bg-primary z-10 rounded-xl px-4 py-1 shrink-0">
                <span className="text-background text-base font-medium select-none">
                  About
                </span>
              </div>
              <SquigglyLine className="opacity-60" />
        ...
        {/* === OLD SKILLS (left-aligned + pink underline animation) ===
        <section id="skills">
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 9}>
              <div className="space-y-3">
                <h3 className="text-2xl font-bold tracking-tighter sm:text-3xl">
                  Check out my{" "}
                  <Link
                    href="https://drive.google.com/file/d/1GO91p5__KYka7NeaJrjOdS9VgwdBgF2-/view?usp=sharing"
                    target="_blank"
