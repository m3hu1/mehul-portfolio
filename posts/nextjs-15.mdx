...
- [Breaking: Async Request APIs](#breaking-async-request-apis)
- [Breaking: Caching](#breaking-caching)
- [React 19 Support](#react-19-support)
- [Server Actions](#server-actions)
- [Better Forms](#better-forms)
- [Turbopack Dev](#turbopack-dev)
- [Static Route Indicator](#static-route-indicator)
- [next.config.ts](#nextconfigts)
- [Self Hosting Improvements](#self-hosting-improvements)
- [ESLint 9 Support](#eslint-9-support)
- [Enhanced Codemod CLI](#enhanced-codemod-cli)
