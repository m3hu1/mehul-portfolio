...
- [Extending shadcn/ui: Additional Libraries](#extending-shadcnui-additional-libraries)
   - [shadcn/ui expansions](#shadcnui-expansions)
   - [Shadcn Extension](#shadcn-extension)
